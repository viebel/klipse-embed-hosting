<?php 
  $screenshot_url = "https://api.urlbox.io/v1/JejmqldbRkoarwiU/jpg?height=300&wait_until=requestsfinished&url=" . urlencode("https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
?>
<!doctype html>
