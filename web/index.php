<?php 
  $screenshot_url = "https://api.urlbox.io/v1/JejmqldbRkoarwiU/jpg?aaselector=.klipse-snippet-container&full_page=true&width=564&height=295&wait_until=requestsfinished&url=" . urlencode("https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
?>
<!doctype html>
